 ...
 */
public class WebSocketManager3 {

    private static WebSocketManager3 instance;
    private MyWebSocketClient webSocketClient;
    private WebSocketListener webSocketListener;

    private WebSocketManager3() {}
     ...
     */
    public static synchronized WebSocketManager3 getInstance() {
        if (instance == null) {
            instance = new WebSocketManager3();
        }
        return instance;
    }
