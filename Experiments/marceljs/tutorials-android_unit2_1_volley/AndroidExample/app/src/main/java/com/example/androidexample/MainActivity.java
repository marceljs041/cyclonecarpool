...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button strBtn, jsonObjBtn, jsonArrBtn, imgBtn, uploadProfileImgBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadProfileImgBtn = findViewById(R.id.btnUploadProfileImage);
        ...
        uploadProfileImgBtn.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.btnUploadProfileImage) {
            startActivity(new Intent(MainActivity.this, UploadProfileImageActivity.class));
        }
